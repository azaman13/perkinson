...
def main(K):
    ...
    for f in testing_files:
        ...
        pred_y = 1.0 / (len(models)) * pred_y_per_patient
    ...
    plt.savefig('gbm_model_figs/avg_gbm_model_feature_accuracy.png')
    ...
    a = ax.get_figure()
    a.savefig('gbm_model_figs/test_error_matrix.png')
    ...
    for feature_num in range(100):
        ...
        fig.savefig('gbm_model_figs/feature_error_hists/'+name, bbox_inches='tight')
